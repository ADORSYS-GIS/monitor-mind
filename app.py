...
def get_memory():
    ...
    ram_timestamps, ram_usage = memory_service.get_ram_usage_array()
    swap_timestamps, swap_usage = memory_service.get_swap_usage_array()
    return jsonify(ram_timestamps=ram_timestamps, ram_usage_history=ram_usage,swap_timestamps=swap_timestamps, swap_usage_history=swap_usage)
